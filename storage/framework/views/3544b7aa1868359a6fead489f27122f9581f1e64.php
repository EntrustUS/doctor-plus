	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
						<span class="user-img"><img class="rounded-circle" src="../assets_admin/img/profiles/avatar-01.jpg" width="31" alt="Shailesh Patel"></span>
					</a>
		...
		<!-- /Header --><?php /**PATH D:\laragon\www\doctor-plus\resources\views/layout/partials/header_admin.blade.php ENDPATH**/ ?>