					...
					<div class="row">
						...
						<div class="col-lg-8 col-md-12">
							...
							<div class="blog">
								...
								<h3 class="blog-title"><a href="blog-details">Doctor Plus – Making your clinic painless visit?</a></h3>
								...
								<div class="card-body">
									<ul class="latest-posts">
										<li>
											...
											<div class="post-info">
												<h4>
													<a href="blog-details">Doctor Plus – Making your clinic painless visit?</a>
												</h4>
												<p>4 Dec 2019</p>
											</div>
										</li>
							...
							<div class="card tags-widget">
								...
								<div class="card-body">
									<ul class="tags">
										...
										<li><a href="#" class="tag">Doctor Plus</a></li>
									</ul>
								</div>
							</div>
							<!-- /Tags -->
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\doctor-plus\resources\views/blog-list.blade.php ENDPATH**/ ?>